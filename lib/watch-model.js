...
=========================================================
 IRAQ EMPIRE CINEMA
 Watch / Episode / Chapter Model
=========================================================

هذا الملف لا يجلب الحلقات من الإنترنت ولا يخترع أي حلقة.
وظيفته توحيد شكل البيانات القادمة من مصادر المشاهدة
والتأكد من أن الواجهة تعرض فقط المواسم والحلقات والفصول
التي لديها بيانات حقيقية ومصدر صالح.
=========================================================
*/
...
function hasWatchSources(item) {
    return normalizeSources(item?.sources).length > 0;
}
...
function normalizeEpisode(episode) {
    ...
    return {
        ...
        duration: Number.isFinite(Number(episode.duration))
...
function normalizeChapter(chapter) {
    ...
    if (!Number.isFinite(number) || number < 1 || sources.length === 0) {
        return null;
    }
    ...
    return {
        ...
        pages: Number.isFinite(Number(chapter.pages))
