...
(function attachIndexAccount() {
    ...
    function mount(user) {
        ...
        const control = user ? createAccountControl(user) : createLoginButton();
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            .discord-index-login {
                ...
                border-radius: 12px;
                padding: 9px 13px;
                background: rgba(212,166,67,.09);
                color: #e4bd62;
                cursor: pointer;
                font-weight: 700;
                white-space: nowrap;
            }
            .discord-index-login:hover {
                background: rgba(212,166,67,.16);
            }
            .discord-index-account {
                display: flex;
                align-items: center;
            ...
            .discord-index-profile {
                ...
                max-width: 190px;
                padding: 4px 8px;
                border: 1px solid rgba(212,166,67,.28);
                border-radius: 12px;
                color: inherit;
                text-decoration: none;
                background: rgba(255,255,255,.025);
            }
            .discord-index-avatar {
                width: 30px;
                height: 30px;
                flex: 0 0 30px;
                border-radius: 50%;
                object-fit: cover;
                border: 1px solid rgba(212,166,67,.55);
            }
            .discord-index-avatar-fallback {
                display: grid;
                place-items: center;
                color: #e4bd62;
                background: #151014;
            ...
            @media (max-width: 900px) {
                .discord-index-name { display: none; }
                .discord-index-profile { padding: 4px; }
            }
            @media (max-width: 620px) {
                .discord-index-login { padding: 8px 9px; font-size: 11px; }
                .discord-index-logout { display: none; }
            }
        `;
